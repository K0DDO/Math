...
## 1. Линейный оператор, матрица, ранг, ядро, дефект, сопряжённый — практика
...
## 2. Изменение матрицы при переходе — практика
...
## 3. Собственные числа/векторы, характеристический многочлен — практика
...
## 5. Билинейные/квадратичные, матрица, диагонализация собственными — практика
...
## 8. Приведение кривых/поверхностей 2 порядка — практика
...
## 10. Построение собственного базиса — практика
...
## 11. ДУ: порядок, общее/частное/особое — практика
...
## 12. Интегральные кривые, изоклины — практика
...
## 13. 1 порядок, Коши, разделяющиеся, однородные — практика
...
## 14. Линейные 1 порядка — практика
...
## 15. Полные дифференциалы и Бернулли — практика
...
## 16. Особое решение, огибающая — практика
...
## 17. Высшие порядки, Коши, понижение — практика
...
## 20. ФСР и структура общего ЛОДУ — практика
...
## 21. Переменные коэффициенты — практика
...
## 22. Неоднородные высшие, вариация — практика
...
## 23. Постоянные коэффициенты однородные — практика
...
## 24. Неоднородные + спец. правая часть — практика
...
## 25. Системы в нормальной форме — практика
...
## 26. Линейные однородные системы, простые корни — практика
...
## 27. Кратные действительные — практика
...
## 30. Неоднородные, спец. правая часть — практика
